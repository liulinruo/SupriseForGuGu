;(function (window) {
  ...
  let texts = ['亲爱的咕咕', '今天是二周年纪念日', '很开心能一起走到今天', '这一年磨合了更多','我们的关系更加牢靠了','不过可恶的疫情','让我们不能如期见面','不过没关系','只要我们彼此相爱','有的是时间在一起','相信我们能走的更远', '希望年年都有今日', '希望年年都是你', '还需要更用心经营哇', '不止二周年', '还有年复一年', '古雯惠，我爱你']
